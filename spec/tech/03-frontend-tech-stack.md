...
@ant-design/x            2.5.0      — AI assistant mode components (Conversations, Welcome, Prompts, Bubble.List, Sender)
...
├── modules/
│   ├── cockpit/
│   │   ├── Cockpit.tsx         # Workbench + resizable AI assistant layout shell
│   │   ├── WorkbenchPanel.tsx  # CENTER: context default tab + content canvas
│   │   ├── ChatPanel.tsx       # RIGHT: @ant-design/x 2.5 assistant mode panel
│   │   ├── ContextDrawer.tsx   # Workbench default tab: KPI + decisions + factor signals
